              ...
              {showPassword ? (
                ...
                >
                  <path
                    ...
                    d="M3.98 8.223A11.055 11.055 0 0022.396 7.23m-21.808 1.45a10.717 10.717 0 013.57-6.332m3.18-.5a10.717 10.717 0 0115.658 0M12 18.75a6 6 0 006-6m-15 0a6 6 0 006 6z"
                  />
                  <path
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    d="M15.121 15.121a3 3 0 01-4.242 0M9.879 18.879a1 1 0 011.414 0l4.242-4.242a1 1 0 010-1.414l-4.242-4.242a1 1 0 01-1.414 0l-4.242 4.242a1 1 0 010 1.414l4.242 4.242z"
                  />
                </svg>
              ) : (
                <svg
