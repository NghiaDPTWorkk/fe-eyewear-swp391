...
export function SaleNavSearch({ className, placeholder }: SaleNavSearchProps) {
...
export function SaleNavActions({
  className,
  userName = 'Sarah L.',
  userRole = 'Sale Staff',
  userInitials = 'SL'
