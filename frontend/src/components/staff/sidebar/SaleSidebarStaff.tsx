...
import { SaleMenuItem } from './SaleMenuItem'
import { SaleMenuSection } from './SaleMenuSection'
import { SaleSubMenuItem } from './SaleSubMenuItem'
import { StoreDropdown } from './StoreDropdown'
import { useLayoutStore } from '@/store/layout.store'
import { HiMenuAlt2 } from 'react-icons/hi'
import { cn } from '@/lib/utils'

interface SaleSidebarStaffProps {
  logo?: ReactNode
  storeName?: string
  storeIcon?: ReactNode
  children: ReactNode
...
export function SaleSidebarStaff({
  logo,
  storeName,
  storeIcon,
  children,
  userWidget
}: SaleSidebarStaffProps) {
...
SaleSidebarStaff.MenuSection = SaleMenuSection
SaleSidebarStaff.MenuItem = SaleMenuItem
SaleSidebarStaff.SubMenuItem = SaleSubMenuItem
