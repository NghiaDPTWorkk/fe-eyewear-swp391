      ...
      <div className="relative w-full max-w-md transform overflow-hidden rounded-[2.5rem] bg-white p-8 text-left align-middle shadow-[0_32px_128px_-16px_rgba(0,0,0,0.3)] transition-all border border-neutral-100/50 animate-in zoom-in-95 duration-300">
        ...
        <div className="space-y-6 mb-8">
          ...
          <div className="space-y-3">
            ...
            <textarea
              ...
              className={cn(
                'w-full h-32 px-6 py-5 bg-neutral-50 border rounded-[1.5rem] text-sm font-medium transition-all focus:outline-none focus:ring-8 placeholder:text-slate-300 resize-none',
                error
            ...
            />
            {error && (
              <p className="text-[10px] font-bold text-rose-500 ml-4 flex items-center gap-2 animate-in slide-in-from-top-2">
        ...
        <div className="flex flex-col gap-3">
          <Button
            ...
            disabled={isLoading}
            className="w-full bg-rose-500 hover:bg-rose-600 text-white rounded-2xl h-14 font-bold text-sm tracking-wide shadow-xl shadow-rose-100 border-none transition-all active:scale-95 disabled:grayscale flex items-center justify-center"
          >
            {isLoading ? (
