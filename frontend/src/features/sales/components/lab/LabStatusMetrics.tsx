...
export const LabStatusMetrics: React.FC = () => {
  return (
    <div className="col-span-12 lg:col-span-3 space-y-4">
      ...
      <Card className="p-4 border border-neutral-100 flex items-center justify-between bg-white shadow-sm rounded-xl">
        <div>
          <p className="text-[11px] font-semibold text-neutral-400 tracking-wider">Urgent / Late</p>
      ...
      <Card className="p-4 border border-neutral-100 flex items-center justify-between bg-white shadow-sm rounded-xl">
        <div>
          <p className="text-[11px] font-semibold text-neutral-400 tracking-wider">Ready for QC</p>
