    ...
    <div className="space-y-6 pb-20 animate-in fade-in slide-in-from-right-4 duration-300 font-sans">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-6">
          ...
          <div className="flex flex-col gap-1">
            <div className="flex items-center gap-4">
              ...
              <span className="px-3 py-1 bg-[#dcfce7] text-[#15803d] text-[9px] font-normal uppercase tracking-widest rounded-full border border-[#bbf7d0] cursor-pointer shadow-sm">
                {order.status}
              </span>
            </div>
            <div className="flex items-center gap-5 mt-1.5">
              ...
              <div className="flex items-center gap-2 text-[13px] font-normal text-slate-500">
                <IoCubeOutline className="text-slate-400" size={16} />
        ...
        <div className="flex gap-3">
          <Button
            variant="outline"
            className="border-slate-200 text-slate-600 bg-white hover:bg-slate-50 hover:text-slate-900 font-normal rounded-xl px-5 h-10 transition-all border shadow-sm"
            leftIcon={<IoPrintOutline size={18} />}
          >
            Invoice
          </Button>
          <Button
            className="bg-emerald-500 hover:bg-emerald-600 text-white font-normal shadow-md shadow-emerald-100/50 border-none rounded-xl px-5 h-10 transition-all active:scale-95"
