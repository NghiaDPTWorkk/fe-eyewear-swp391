...
import { PrescriptionActions } from './PrescriptionsActions'
...
export const PrescriptionRow: React.FC<PrescriptionRowProps> = ({ order, onVerify, onReject }) => {
  ...
  return (
    <tr className="border-b border-neutral-50 hover:bg-neutral-50/50 transition-colors group text-center">
      ...
      <td className="px-6 py-5">
        <PrescriptionActions order={order} onVerify={onVerify} onReject={onReject} />
      </td>
    </tr>
  )
}
