            ...
            {PRODUCTS.map((p, idx) => (
              <tr key={idx} className="hover:bg-neutral-50/30 transition-colors group">
                <td className="pl-10 px-6 py-6">
                  ...
                  <span className="text-[11px] text-[#a4a9c1] font-medium block">{p.email}</span>
                </td>
                <td className="px-6 py-6">
                  <span className="text-sm font-medium text-[#3d4465] mb-0.5">{p.category}</span>
                  <span className="text-[11px] text-[#a4a9c1] font-medium block">{p.date}</span>
                </td>
