...
export function DrawerOrderTimeline({ timeline }: DrawerOrderTimelineProps) {
  return (
            ...
            <div key={index} className="relative flex gap-4 group">
              ...
              <div className="flex-1 pt-2">
                <div className="flex flex-col">
                  <h4
                    className={`font-semibold text-[13px] ${isCurrent ? 'text-emerald-500' : isCompleted ? 'text-gray-900' : 'text-gray-400'}`}
                  >
                    {step.label}
                  </h4>
                  {step.time !== 'Pending' && (
