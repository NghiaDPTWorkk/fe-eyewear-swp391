              ...
              >
                <td className="px-6 py-6 font-primary">
                  <div className="flex items-center gap-4">
                    ...
                    <span
                      className={`text-sm font-semibold transition-all border-b border-transparent ${isSelected ? 'text-mint-700 border-mint-700' : 'text-gray-900 group-hover:text-mint-600 group-hover:border-mint-600 underline-offset-4 cursor-pointer font-bold'}`}
                    >
                      {user.name}
                    </span>
                  </div>
