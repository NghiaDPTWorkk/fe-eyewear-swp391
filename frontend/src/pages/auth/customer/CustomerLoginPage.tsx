      ...
      <div className="flex-1 overflow-y-auto p-4 lg:p-5">
        <div className="flex h-full min-h-fit items-center justify-center">
          <div className="grid w-full max-w-[1024px] grid-cols-1 overflow-hidden rounded-[32px] backdrop-blur-2xl lg:grid-cols-2">
            ...
            <div className="animate-slide-in-right relative hidden flex-col items-start justify-center overflow-hidden bg-black/40 lg:flex">
              <div className="absolute inset-0 bg-[#ffffff] opacity-100 mix-blend-multiply">
                <img
                  src={signinPremium}
                  alt="Premium Eyewear"
        ...
        <div className="mx-auto flex max-w-[1024px] flex-col items-center justify-between gap-6 lg:flex-row lg:gap-0">
          ...
          <div className="flex gap-4">
            ...
            >
              ...
              >
                <path d={SIGN_IN_SVG_PATHS.share} fill="white" />
              </svg>
            </a>
          </div>
        </div>
