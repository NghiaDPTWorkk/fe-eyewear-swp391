...
import { Glasses, Search, ShoppingCart, User, X, Heart } from 'lucide-react'
        ...
        !isSearchExpanded ? (
          <nav className="flex items-center gap-8 transition-all duration-300">
            <Link
              ...
              } hover:text-primary-500 transition-all relative group`}
            >
              Home
              <span
            ...
            >
              ...
              <span
                className={`absolute bottom-0 left-0 w-full h-0.5 bg-primary-500 transform ${
                  isActive('/eyeglasses') ? 'scale-x-100' : 'scale-x-0'
                } group-hover:scale-x-100 transition-transform`}
              ></span>
            </Link>
            <Link
