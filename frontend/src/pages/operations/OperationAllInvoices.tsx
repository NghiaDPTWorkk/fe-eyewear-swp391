...
export default function OperationAllInvoices() {
  ...
  return (
    <Container className="animate-fade-in-up relative">
      {/* Breadcrumb */}
      ...
      {/* Invoice Detail Sidebar (Popup) - Rendered into Portal */}
      {createPortal(
        <>
          {/* Overlay */}
          <div
            className={`fixed inset-0 bg-neutral-900/60 backdrop-blur-sm z-[9998] transition-opacity duration-300 ${
          ...
          <div
            className={`fixed right-0 top-0 h-full w-[450px] bg-white shadow-2xl z-[9999] transform transition-transform duration-300 ease-out border-l border-neutral-100 flex flex-col ${
                ...
                <div className="flex-1 overflow-y-auto px-8 py-6 space-y-8 bg-neutral-50/50">
                  ...
                  <div className="pt-6 border-t border-neutral-200 border-dashed">
                    <div className="flex justify-between items-end">
                      <span className="text-neutral-500 font-medium text-sm mb-1">
                        Total Amount
                      </span>
