  ...
  return (
    <Container>
      <div className="mb-8">
        ...
        <h1 className="text-2xl md:text-3xl font-bold text-gray-900 tracking-tight">Operation Hub</h1>
        <p className="text-sm md:text-base text-gray-500 mt-1">Monitor priority orders and technical station status.</p>
