    ...
    <Container>
      <div className="mb-8">
        <div className="flex items-center gap-2 text-sm pt-8 mb-6 font-medium">
          ...
          <span className="text-primary-500 font-bold">System Technical</span>
        </div>
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-12 text-center">
        <div className="max-w-md mx-auto">
          ...
          <h2 className="text-xl font-semibold text-gray-900 mb-2">Technician Dashboard</h2>
          <p className="text-gray-500">
            Technical documentation and workstation controls will appear here. This section is
