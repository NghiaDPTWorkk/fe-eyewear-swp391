...
export default function SaleStaffCustomerPage() {
  ...
  return (
    <Container className="max-w-[1400px] bg-neutral-50/30 min-h-screen pb-10">
      <div className="pt-8 mb-8">
        ...
        <h1 className="text-3xl font-bold text-neutral-800 tracking-tight">Customer Database</h1>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
        {customers.map((customer, idx) => (
          <Card
            key={idx}
            className="p-8 border-none shadow-sm hover:shadow-xl transition-all duration-300 group relative bg-white rounded-[32px]"
          >
            <div className="flex items-start justify-between mb-6">
              ...
              <button className="p-2 text-neutral-300 hover:text-neutral-500 transition-colors rounded-full hover:bg-neutral-50">
