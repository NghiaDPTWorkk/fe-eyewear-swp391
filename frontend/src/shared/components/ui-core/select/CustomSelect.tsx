  ...
  return (
    <div className={cn('space-y-2.5', className)} ref={containerRef}>
      ...
      <div className="relative group/select">
        ...
        {/* Dropdown List */}
        {isOpen && (
          <div className="absolute z-50 w-full mt-3 bg-white/80 backdrop-blur-xl border border-slate-200/50 rounded-2xl shadow-[0_24px_64px_-12px_rgba(0,0,0,0.14)] p-3 max-h-72 overflow-y-auto animate-in fade-in zoom-in-95 duration-200 origin-top">
            <div className="space-y-1.5">
              {options.map((option) => (
                <button
                  ...
                  className={cn(
                    'w-full flex items-center gap-4 px-5 py-3.5 rounded-xl text-sm font-semibold transition-all group/opt relative overflow-hidden',
                    value === option.value
